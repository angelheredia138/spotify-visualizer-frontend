  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const fetchListeningTime = fetch(
        "https://herediabackend.com/api/total_listening_time",
        { headers }
      );
      const fetchUniqueGenres = fetch(
        "https://herediabackend.com/api/unique_genres",
        { headers }
      );
      const fetchUniqueArtists = fetch(
        "https://herediabackend.com/api/unique_artists",
        { headers }
      );
      const fetchTrends = fetch(
        "https://herediabackend.com/api/trends_insights",
        {
          headers,
        }
      );
